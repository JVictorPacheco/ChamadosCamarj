...
public class AtualizarUsuarioPerfilValidatorTests
{
    private readonly AtualizarUsuarioPerfilCommandValidator _validator = new();

    private static AtualizarUsuarioPerfilCommand ComandoValido() => new(
        Guid.NewGuid(),
        "Vitor",
        Perfil.Admin,
        true);
